...
const API_BASE = import.meta.env.VITE_API_BASE_URL || 'http://localhost:10003/api'
...
export default class AdminService {
   ...
   * @returns {Promise<object>} 操作结果
   */
  async redetectAllEmails() {
    return this.client.post('/admin/redetect')
  }
  ...
  async updateSystemSettings(payload) {
    return this.client.put('/admin/settings', payload)
  }
}
